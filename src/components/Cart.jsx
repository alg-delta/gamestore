...
export default function Cart({ cartItems, add, remove, buy }) {
  ...
  return (
    <Alert variant="success">
        ...
        {cartItems.map((product) => (
          <tr key={product.id}>
            ...
            <td width="25%">
              ...
              {product.number}
              <Button variant="success" onClick={() => add(product)}>
                +
              </Button>
            </td>
      ...
      <hr />
      <p className="mb-0">
        Насолождуйтесь іграми , котрі ми продаємо для вас , але є одне правило
        не копіюйте гру , і не переосьте на інший комп'ютер (не Піратствуйте)
      </p>
